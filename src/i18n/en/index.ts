	...
	pages: {
		...
		about: {
			...
			logos: {
				...
				ICLEI: {
					title:
						"Logo of the Local Government for Sustainability EUROPE (ICLEI)",
					url: "https://iclei.org/",
				},
				googleOrg: {
		...
		choroplethLegend: {
			...
			healthRisks: {
				"extreme cold stress": {
					...
					description:
						"Life-threatening hypothermia, severe frostbite possible within minutes.",
					ranges: {
						pet: "",
						utci: "below -40 °C",
					},
				...
				"strong cold stress": {
					...
					description:
						"Risk of frostbite for exposed skin areas, increased risk of cold injuries.",
					ranges: {
						pet: "4 to 8 °C",
						utci: "-27 to -13 °C",
					},
				...
				"moderate cold stress": {
					...
					description:
						"Shivering, discomfort, risk of frostbite with prolonged exposure.",
					ranges: {
						pet: "8 to 13 °C",
						utci: "-13 to 0 °C",
					},
				...
				"strong heat stress": {
					...
					description:
						"Increased cardiovascular strain, risk of dehydration and exhaustion.",
					ranges: {
						pet: "29 to 35 °C",
						utci: "32 to 38 °C",
					},
